...
@card_router.get("/", response_model=List[schemas.CardBase])
...
@card_router.post("/", response_model=schemas.CardBase)
...
@card_router.put("/{card_id}", response_model=schemas.CardCreate)
