...
@transaction_router.get("/", response_model=schemas.TransactionData)
...
@transaction_router.get("/details", response_model=List[schemas.TransactionBase])
...
@transaction_router.post("/", response_model=schemas.TransactionCreate)
